...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Institute_Sync', fields ['institute', 'record', 'change_type', 'model_name']
        db.create_unique('mooc_institute_sync', ['institute_id', 'record', 'change_type', 'model_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Institute_Sync', fields ['institute', 'record', 'change_type', 'model_name']
        db.delete_unique('mooc_institute_sync', ['institute_id', 'record', 'change_type', 'model_name'])
    ...
    models = {
        ...
        'mooc.institute_sync': {
            'Meta': {'unique_together': "(('institute', 'model_name', 'change_type', 'record'),)", 'object_name': 'Institute_Sync'},
            'change_type': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mooc.Institute_Registration']"}),
            'model_name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'record': ('django.db.models.fields.IntegerField', [], {})
        },
        'mooc.person': {
