...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student_Identity.user'
        db.add_column('mooc_student_identity', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding unique constraint on 'Student_Identity', fields ['institute_identity', 'user', 'number']
        db.create_unique('mooc_student_identity', ['institute_identity_id', 'user_id', 'number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Student_Identity', fields ['institute_identity', 'user', 'number']
        db.delete_unique('mooc_student_identity', ['institute_identity_id', 'user_id', 'number'])

        # Deleting field 'Student_Identity.user'
        db.delete_column('mooc_student_identity', 'user_id')
    ...
    models = {
        ...
        'mooc.student_identity': {
            'Meta': {'unique_together': "(('user', 'institute_identity', 'number'),)", 'object_name': 'Student_Identity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
