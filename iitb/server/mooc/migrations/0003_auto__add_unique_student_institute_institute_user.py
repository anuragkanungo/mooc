...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Student_Institute', fields ['institute', 'user']
        db.create_unique('mooc_student_institute', ['institute_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Student_Institute', fields ['institute', 'user']
        db.delete_unique('mooc_student_institute', ['institute_id', 'user_id'])
